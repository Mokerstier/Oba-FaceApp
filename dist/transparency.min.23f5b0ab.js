...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/vendor/transparency.min.js":[function(require,module,exports) {
var define;
...
!function t(e, n, r) {
  ...
  2: [function (t, e, n) {
    ...
    a = t('../lib/lodash'), h = t('./helpers'), e.exports = i = {
      Attributes: {},
      createAttribute: function createAttribute(t, e) {
        var n;
      ...
      for (c(e, t), n = ['hidden', 'async', 'defer', 'autofocus', 'formnovalidate', 'disabled', 'autofocus', 'formnovalidate', 'multiple', 'readonly', 'required', 'checked', 'scoped', 'reversed', 'selected', 'loop', 'muted', 'autoplay', 'controls', 'seamless', 'default', 'ismap', 'novalidate', 'open', 'typemustmatch', 'truespeed'], r = 0, o = n.length; o > r; r++) {
      ...
      function e(t, e) {
        ...
        this.el = t, this.name = e, this.templateValue = function () {
          ...
          for (r = this.el.childNodes, i = [], t = 0, e = r.length; e > t; t++) {
  ...
  4: [function (t, e, n) {
    ...
    p = t('../lib/lodash.js'), f = t('./helpers'), r = t('./attributeFactory'), e.exports = s = {
      ...
      createElement: function createElement(t) {
        var e, n;
      ...
      return t.prototype.empty = function () {
        ...
        for (i in n) {
          d.call(n, i) && (r = n[i], 'function' == typeof r && (s = r.call(t, {
            element: this.el,
            index: e,
      ...
      return m(e, t), s.Elements.select = e, e.prototype.render = function (t) {
        ...
        for (t = t.toString(), i = this.elements, o = [], e = 0, n = i.length; n > e; e++) {
      ...
      for (m(e, t), n = ['area', 'base', 'br', 'col', 'command', 'embed', 'hr', 'img', 'input', 'keygen', 'link', 'meta', 'param', 'source', 'track', 'wbr'], r = 0, i = n.length; i > r; r++) {
  ...
  5: [function (t, e, n) {
    ...
    r = t('./elementFactory'), n.before = function (t) {
      ...
      var e, r, i, s, u;
      if (e = Transparency.clone(t), e.nodeType === n.ELEMENT_NODE) for (e.removeAttribute(o), u = e.getElementsByTagName('*'), i = 0, s = u.length; s > i; i++) {
  ...
  6: [function (t, e, n) {
    ...
    i = t('../lib/lodash.js'), o = (s = t('./helpers')).chainable, e.exports = r = function () {
      ...
      return t.prototype.remove = o(function () {
        ...
        for (r = this.childNodes, i = [], t = 0, e = r.length; e > t; t++) {
        ...
        for (i = this.childNodes, o = [], e = 0, n = i.length; n > e; e++) {
        ...
        if ('object' == _typeof(t)) {
          ...
          for (r in t) {
            u.call(t, r) && (s = t[r], null != s && (i.isString(s) || i.isNumber(s) || i.isBoolean(s) || i.isDate(s) ? o.push(function () {
              ...
              for (i = this.matchingElements(r), o = [], t = 0, e = i.length; e > t; t++) {
                n = i[t], o.push(n.render(s));
              }

              return o;
            }.call(this)) : 'object' == _typeof(s) ? o.push(e.push(r)) : o.push(void 0)));
          }
        ...
        for (o in n) {
          u.call(n, o) && (r = n[o], 'object' == _typeof(r) && ('object' != _typeof(t) && (t = {
            value: t
          }), s.push(function () {
            var n, s, u, l;

            for (u = this.matchingElements(o), l = [], n = 0, s = u.length; s > n; n++) {
        ...
        for (l = [], o = 0, u = e.length; u > o; o++) {
          s = e[o], l.push(function () {
            ...
            for (u = this.matchingElements(s), l = [], e = 0, o = u.length; o > e; e++) {
        ...
        return r = (e = this.queryCache)[t] || (e[t] = function () {
          ...
          for (i = this.elements, o = [], e = 0, r = i.length; r > e; e++) {
  ...
  7: [function (t, e, n) {
    ...
    r.toString = Object.prototype.toString, r.toArray = function (t) {
      ...
      var e;
      return e = _typeof(t), 'object' !== e && 'function' !== e || n.isDate(t);
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/vendor/transparency.min.js"], null)
//# sourceMappingURL=/transparency.min.23f5b0ab.js.map